...
export function SlideOver({ open, onClose, title, description, children, className }: SlideOverProps) {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed right-0 top-0 z-[95] h-full w-full max-w-[480px] border-l border-border-subtle bg-navy-primary shadow-industrial-lg transition-transform duration-300",
